...
**Observación**. Si hay m artículos, entonces el número de posibles subconjuntos es $2^m$ (número de elementos del conjunto potencia) y el número total de subconjuntos de tamaño k es $\binom{m}{k}$
...
El siguiente ejemplo ayuda a entender mejor el principio de monoticidad 


[ejemplo](https://en.wikipedia.org/wiki/Conjunction_fallacy)
